...
function render(event) {
  ...
  result.innerHTML = `
    ...
    <div class="result-card kyusei-card">
      ...
      <div class="kyusei-board-wrap expert-only">
        <h4>${kyuseiResult.adjustedYear}年 年盤</h4>
      ...
      <div class="kyusei-sub-section">
        <div class="kyusei-board-wrap expert-only">
          <h4>${kyuseiResult.monthLabel}の月盤</h4>
      ...
      <div class="kyusei-sub-section">
        <div class="kyusei-board-wrap expert-only">
          <h4>${kyuseiResult.targetDate.getMonth()+1}月${kyuseiResult.targetDate.getDate()}日の日盤</h4>
          <div class="kyusei-board kyusei-board-sm">
            ${[4, 9, 2, 3, 5, 7, 8, 1, 6].map(pos => {
