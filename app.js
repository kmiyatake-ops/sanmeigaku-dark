  ...
  return dirs.map(d => {
    ...
    if (d.key === "north") {
      advice = isNatural
        ...
        : "目上から応援されやすい恵まれた関係。ただし依存しすぎず、自分の力も大切にするとさらに良くなります。";
    } else if (d.key === "east") {
      advice = isNatural
        ? "社会と対立しやすい、または似た性質の関係。苦労はあるが、自力で成長できる環境です。"
        : "社会から支援されやすい関係。ただし甘えすぎず、自力で立ち上がる訓練を意識すると良いです。";
    } else if (d.key === "south") {
      advice = isNatural
...
const mismatchTexts = {
  5: "現実と精神が完全に逆回転する型。会社員よりフリーランス、芸術・企画・研究など型破りな道で才能が爆発する。常識に従うと息苦しくなるので、自分の世界を貫くのが開運の鍵。周りと違うことを恐れず、想像力を武器に生きる人。",
  ...
  0: "完全に現実と精神が一致する型。守りを徹底することが最も運を呼ぶ。引越しや転職は最小限にし、年中行事や地域の行事を大切にすると運が安定する。地元で地道に信頼を積み上げるのが最良の生き方。変化より継続が運を開く。"
};
...
const energyLifeInterpretation = {
  ...
  "天胡星": {
    ...
    middleAge: "地に足の着いた生活に疑問を抱きやすい時期。堅実な会社員生活に「これでいいのか？」と悩み始める。夢見がちで、現実的な生き方をしていると全く違う価値観が芽生える。40代で突然音楽を始め、プロを目指し始める。もともと音楽や芸術の仕事に就いていれば才能が活かされる。デザイナーとして独自の世界観で評価される。根を詰める働き方とは相性が良くない。毎日残業続きだと体調を崩す。集中力が凄まじく、精神が肉体を追い込むほど成果が出る。徹夜で作品を作り続け、傑作を生み出す。しかし希望を失うと絶望に沈む。作品が評価されないと数ヶ月引きこもる。",
  ...
  "天馳星": {
    ...
    lateLife: "せわしく動き回る晩年。体を動かすことが心の平穏につながる。毎日朝の散歩を欠かさない、趣味の園芸で毎日庭仕事をする。お金や名誉には無欲なので、社会的な活動より趣味に活動の幅が広がる。複数の趣味を同時に楽しみ、毎日忙しい。体の衰えを感じると少し穏やかになる。70代まではハイキング、80代からは近所の散歩に変える。単独行動をしがちなので身勝手が過ぎると孤独に。自分のペースでばかり動いて家族から「付き合いが悪い」と言われる。家族や友人を大事にすれば穏やかで自由な晩年に。"
  },
};
