...
const loveTypeTexts = {
  ...
  牽牛星: {
    ...
    dislike: "初対面でタメ口を使う人や、高級店でスマホをいじる人。品とけじめで人を測るので、そういう細かい所作が崩れている人には生理的に無理。",
    marriage: "お互いを高め合える、知性と気品を兼ね備えた、対等なパートナーになれる人。"
  },
  龍高星: {
    like: "個性的で自由な発想を持つ、束縛しない人に惹かれやすい。",
    dislike: "『今どこにいるの？』『誰といるの？』と毎時間連絡してくる人や、スマホの画面を覗き込む人。自由を制限されることは愛情ではなく暴力。",
...
const sexTendencyTexts = {
  ...
  龍高星: {
    ...
    caution: "マンネリに弱く、新しい相手への関心が移りやすい"
  },
  玉堂星: {
    keyword: "知的・精神重視",
...
const energyLifeInterpretation = {
  "天報星": {
    childhood: "好奇心旺盛で色々なことに興味を持ち、器用にこなせる子ども。例：勉強もスポーツもそこそこできるが、一つに絞れず部活を転々とする。親の期待通りには進みにくく、自分なりの道を探す。20代までは定職が決まりにくく、転職やバイト変更が多い。例：飲食店→アパレル→IT系と職種が変わる。早めに一つに絞って粘り強く取り組めば、30代以降の飛躍の土台になる。",
    middleAge: "人生が大きく変わる出来事が起きやすい時期。例：30代で脱サラして独立する、40代で全く別の業界に転職する。現状維持ができず、新しい分野に挑戦し続ける。短期決戦を繰り返しながら上昇するが、例：一気に仕事を受けて燃え尽き、数ヶ月休んでまた動き出すパターン。30歳前後に決めたことを続けていれば安定する。恋愛では刺激を求めるため、マンネリになると浮気や別れの危機。例：付き合って3年で刺激がなくなり別れる。",
    lateLife: "年齢を重ねても若々しく活動的な晩年。例：60代で新しい趣味を始め、70代で海外移住を検討する。引っ越しを繰り返したり、新しいことを始めたりと落ち着きがない反面、型破りな経験が若者からの憧れの的になる。例：孫に「おじいちゃん（おばあちゃん）面白い」と言われる。ただし家族を巻き込む変化を求めると摩擦が起きる。例：勝手に引っ越しを決めて家族と揉める。"
  },
  "天印星": {
    childhood: "無邪気で人なつっこく、いるだけで場を明るくする愛されキャラ。例：クラスの人気者で、先生にも同級生にも好かれる。あわてんぼうで小さなミスは多いが、憎めないので許される。例：忘れ物をしても「またか」と笑って済まされる。ただし甘えすぎると自立できなくなる。例：20代になっても親に頼りきりで生活費を送ってもらう。早めに「自分でやる習慣」をつけないと中年期以降に愛想を尽かされる。",
    middleAge: "大人になっても甘さが残る時期。例：うっかりミスで書類を間違えるが、笑って許される。不思議と人の引き立てに恵まれ、自分から先陣を切るより既存の環境を受け入れて引き継ぐ方が成功する。例：先代の事業をそのまま受け継んで安定経営する。人間関係に恵まれ、職場でもプライベートでも笑いの多い生活。浮き沈みが少なく苦労が少ない反面、怠けぐせが出やすい。例：仕事が順調だと油断してスキルアップを怠る。",
    lateLife: "若者や子どもに好かれ、囲まれる穏やかな晩年。例：地域のボランティアで子どもたちと触れ合い、笑顔で慕われる。安定的な運勢なので、蓄えをたっぷり持っておけば心配の少ない人生に。例：定年後も趣味のサークルで人気者として楽しく過ごす。これまで人に好かれて生きてきた経験が、若者の道標になる。"
  },
  "天貴星": {
    childhood: "自分の考えに自信があり、良いと思ったことは忠実に守る子ども。例：勉強方法にこだわりがあり、親が別の方法を勧めても自分のやり方を貫く。大人の言うことには一つ一つ疑問を抱き、納得するまで聞かないため反抗的と思われることも。例：「なぜそうするの？」と毎回質問して親を困らせる。自意識が高く周囲の目を気にするので、基本は大人しく目立たないようにする。純粋ゆえに騙されやすい。例：友達に裏切られて初めて人を疑うことを学ぶ。",
    middleAge: "真面目にやるべきことを全うし、学び続ける安定した中年期。例：会社で確実に業務をこなし、資格を取って昇進する。責任感があり高い地位につくことも。ただプライドが高く「泥臭く頼む」ことができない。例：取引先に頭を下げるのが苦手で受注を逃す。受け身でチャンスを掴みに行けない弱点あり。恋愛では自分から積極的に行けない。例：好きな人がいても確信がないと動けず、結局相手に先を越される。金銭感覚がルーズなので信頼できる人に管理を任せるのが安全。例：家計は配偶者に任せる。",
    lateLife: "活力に溢れた晩年。例：定年後も現役で働き、若者に教える立場で活躍する。気持ちは若いが体力が追いつかずもどかしさを感じる。例：孫と走って競争したが息切りして悔しがる。若者から年寄り扱いされると傷つく。例：「おじいちゃん（おばあちゃん）無理しないで」と言われて不機嫌になる。得た知識を活かして尊敬されるには、心は若くても大人な態度を示すことが大切。後進を導く円熟した時期で、多くの人に慕われる。"
  },
  "天恍星": {
    childhood: "自立心が強く、成人までに親元を離れることで運が開く。例：高校で寮生活、大学で一人暮らしを始める。実家に留まるとチャンスが来ない。例：実家で暮らし続けると就職先が決まらない。恋に恋する理想家で、人に期待しすぎて裏切られるとショックが大きい。例：付き合った相手に理想を押し付け、期待と違うと激しく落ち込む。引っ越しや転校が多く、常識に縛られない自由な発想が才能。例：学校の課題で誰も思いつかないアプローチを提案して褒められる。",
    middleAge: "自由で開放的な中年期。型にはまることを嫌い、気の向くままに動く。例：安定した会社員生活を捨てて海外で仕事を始める、突然フリーランスに転身する。簡単に手の届くことには興味を示さず、冒険的な道を選ぶ。人生への満足度は高いが、恋愛面ではトラブルがつきもの。例：モテるため浮気や不倫の問題が起きやすい。離郷やキャリアチェンジを繰り返しながら本質を表に出していく。例：30代で別の業界、40代でまた別の業界と変化を続ける。",
    lateLife: "年齢を重ねてもフレッシュさとときめきを忘れない晩年。例：60代で新しい恋に落ちる、70代で初めて海外旅行に行く。華々しい雰囲気を放ち、若者の気持ちが分かる良き理解者として好かれる。例：若者から「おじいちゃん（おばあちゃん）みたいになりたい」と言われる。恋愛面でも好かれる存在で恋人にも恵まれやすい。これまでの冒険が豊かな経験談となり、常識に縛られない生き方を後進に伝える。"
  },
  "天南星": {
    childhood: "大人のような意見を持ち、正義感の強い子ども。例：5歳で「それは不公平だ」と主張する。批判力があり、些細なことにも理由を求める。例：「なぜこれをやるの？」と毎回納得理由を聞く。白黒はっきりさせたがり、人も好きか嫌いかで分ける。言葉を選ばずはっきり言うので人を傷つけることも。例：友達の作品に「これ下手だね」と正直に言って泣かせる。反抗心が強く無理強いが嫌い。例：親が無理に習い事を勧めると頑として拒否する。この強さを活かせば飛躍につながる。",
    middleAge: "反骨精神と経験値が上手く働き、エネルギッシュな中年期。活動的でリーダーシップがあり、新プロジェクトの立役者になる。例：社内で誰もやりたがらない新規事業を自分から手を挙げて成功させる。猪突猛進で目標に突き進むが、一度挫折すると立ち直るまで時間がかかる。例：失敗して自信を失い、半年間引きこもる。言葉がストレートで計画が甘いところを過去の経験で補えるかが重要。恋愛では好きなら一直線にアプローチする追うタイプ。例：一目惚れで毎日LINEを送りまくる。",
    lateLife: "肉体も精神も老いずに活動的な晩年。例：70代でマラソンに参加し、若者より速いタイムを出す。知識が増え視野が広がり、社会のことにも積極的に意見する。例：地域の町会で改革案を提案して賛否を呼ぶ。説教くさくなると若者から疎まれるので、行動で示す方が良い。例：口で説教するより自分がボランティア活動をして見せる。頑固さは円熟味に変わり、若い世代の道を開く存在に。"
  },
  "天禄星": {
    childhood: "大抵のことには動じず、どっしりと構えた大人びた子ども。例：友達が騒いでいても一人で本を読んでいる。きゃぴきゃぴとはしゃぐことはないが、観察力が鋭く大人と同じ視点を持つ。例：親の悩みに「まあ焦っても仕方ないよ」と諭す。経験の積み重ねで良さが出る星なので、幼少期に色々な経験を積むと後で大きく花開く。例：子ども時代に色々な習い事をした経験が、大人になってから幅広い知識として役立つ。口下手なので話術を身につけると社会に出てから苦労が減る。",
    middleAge: "安心安全な方法を模索し、リスクを取らない安定した中年期。例：転職せず同じ会社で着実に昇進する。温厚な人柄と鋭い観察眼で周囲の信頼が厚い。自分から新しいことに挑戦するタイプではないので、サポート役で冷静に状況を見極めるポジションを保つと良い。例：営業ではなく管理部門で長年活躍する。一芸に秀でる人が多く、スペシャリストとして頭角を表す。例：会計の専門家として社内で欠かせない存在になる。恋愛では慎重派で、友達付き合いから長い時間をかけて恋に発展する。例：何度も食事に行って半年後にやっと付き合う。金運は波が少なく、地道に貯蓄で財を大きくする。",
    lateLife: "中年期の過ごし方をそのまま継続する晩年。実りの多い晩年にするには、中年期に一生味わいたい生活水準に上げておくことが大切。例：定年前に住宅ローンを完済し、老後は趣味を楽しむ。気持ちは働き盛りのままなので活動的に過ごせる。例：定年後も顧問として週2日出勤する。人生経験豊富で話すことに説得力があり、的確な相談役として若者から慕われる。例：後輩から「先生に相談すると道が見えます」と言われる。堅実に築いた基盤が支える安定した晩年。"
  },
  "天将星": {
    childhood: "有り余る最強のエネルギーを抱え、消化しきれず体を壊しがちな子ども。例：小さい頃から熱が出やすく、何度も入院する。親が元気でエネルギッシュな性格か、子どもがスポーツなどでエネルギーを消費すればバランスが取れる。例：激しいスポーツを始めたら病気がぴたりと治まった。緩い環境より努力を強いられる環境で丈夫さが出る。例：厳しい塾に入れたら逆に元気になった。自我と頑固さがどの星より強い。例：自分の意見が絶対で、親が反対しても絶対に譲らない。",
    middleAge: "強いエネルギーで大きな成果を手にする満足度の高い中年期。ただし若い頃に苦労した人に限る。例：20代で苦労して起業した経験が、40代で事業を大きく拡大する基盤になる。甘やかされて育った人はエネルギーの発散方法が分からず傲慢になる。例：何でも思い通りにできたため、40代で初めて挫折した時に周囲が誰も助けてくれない。重い荷を背負っても平気な心の広さと余裕を持つと良い。例：部下の失敗を自分の責任として被り、かえって信頼を集める。創始者の星としてゼロから作り上げることで大成する大器晩成型。",
    lateLife: "若者より精力的に活動するパワフルな晩年。例：70代で新しい事業を立ち上げる、80代まで現役で働く。強い生命力があり長生きする傾向。長い老後をどう過ごすか筋道を立てておくと良い。例：定年後の10年間で何を成し遂げるか目標を立てる。趣味や仕事など生きがいを見つけられれば充実した人生に。例：地域のNPOを立ち上げて代表を務める。波乱の人生を総括し、自我を手放すことで真の円熟に至る。精神性の深化が晩年のテーマ。"
  },
  "天堂星": {
    childhood: "とても落ち着いていて自制心の強い、不思議なほど真面目な子ども。例：幼稚園で他の子が騒いでいる中、一人で静かに遊ぶ。人前に立つのが苦手で、気持ちを表現するのも苦手。例：授業で指されても小声でしか答えられない。若いうちから大人びた慈悲の心を持ち、同年代から頼りにされる。例：クラスで喧嘩が起きると「落ち着いて」と仲裁する。人との交流は多くないが、自分の世界を作り着実に能力を磨く。例：一人で絵を描いたり本を読んだりすることが好き。",
    middleAge: "確かな実力を持って補佐役として活躍する中年期。人の前に出ると臆するので補佐役が適任。例：社長ではなく副社長や右腕として実力を発揮する。トップに立つと波乱が多いので堅実な道を選ぶのが賢明。例：独立の誘いを断り、会社のNo.2として安定した実績を積む。勤勉で実力はあるので、ひっそりと高みを目指すことも可能。例：表舞台に出ず、裏で社内システムを構築して会社に欠かせない存在になる。一歩引いた視点から全体を見渡し、後進に道を譲る。ただし諦めすぎないよう注意。例：昇進のチャンスを「自分には無理」と辞退して後悔する。",
    lateLife: "人生経験から深みのある言動ができる穏やかな晩年。例：孫からの相談に「まあ焦るな、ゆっくり考えな」と優しくアドバイスする。控えめで若者を立てるため幅広い世代に好かれる。例：若手社員から「先生の言葉はいつも腑に落ちます」と慕われる。言葉に深みがあるので人生相談の聞き役として重宝される。例：地域の相談窓口で静かに話を聞き、的確なアドバイスをする。交流の幅を広げておくとより楽しい老後に。"
  },
  "天胡星": {
    childhood: "感受性が鋭く、大人びた雰囲気のある子ども。特に音に敏感で音楽が重要な位置を占める。例：初めて聴いた曲のメロディをすぐに覚えて完璧に歌える。空想家で、一人でいても自分の世界を楽しめる。例：部屋で一人で空想の物語を作り、何時間も遊ぶ。宇宙や不思議なことに興味を示す。例：図鑑の宇宙のページばかり読み返す。その世界に没頭するため友達付き合いは多くない。例：休み時間も一人で絵を描いている。空想と現実の区別がつかなくなることも。例：夢の内容を実際にあったことと思い込む。",
    middleAge: "地に足の着いた生活に疑問を抱きやすい時期。例：堅実な会社員生活に「これでいいのか？」と悩み始める。夢見がちで、現実的な生き方をしていると全く違う価値観が芽生える。例：40代で突然音楽を始め、プロを目指し始める。もともと音楽や芸術の仕事に就いていれば才能が活かされる。例：デザイナーとして独自の世界観で評価される。根を詰める働き方とは相性が良くない。例：毎日残業続きだと体調を崩す。集中力が凄まじく、精神が肉体を追い込むほど成果が出る。例：徹夜で作品を作り続け、傑作を生み出す。しかし希望を失うと絶望に沈む。例：作品が評価されないと数ヶ月引きこもる。",
    lateLife: "子どものような感性を忘れない好奇心旺盛な晩年。例：70代で若者の流行りのTikTokを始める、新しい楽器を覚える。健康さえ守れれば趣味に旅行、仕事と退屈のない生活。例：毎月違う場所に旅行して写真を撮る。若い人たちから助けてもらえる運を持つ。例：若い近所の人が親切にしてくれて助かる。年齢を気にしてできる範囲を決めつける必要はない。例：80代で初めて絵画教室に通い始める。精神の世界に深く沈み込み、美へのあこがれを追求する。希望を持ち続けることで精神的な豊かさを得る。"
  },
  "天極星": {
    childhood: "素直で従順な可愛がられる子ども。例：親の言うことを素直に聞き、幼稚園で先生に褒められる。人の好き嫌いがなく敵を作らない。例：クラスで誰とでも仲良く遊ぶ。誘われるがままに遊び、多数決に従う。例：友達が行くと言えば自分も行く、みんなが赤なら自分も赤にする。親との運勢がかみ合わない。例：親が昇進して忙しい時に限って子どもが病気になる、親が失業している時は子どもが健康で助けになる。病気やケガが長引きやすいので無茶は禁物。例：風邪をこじらせて2週間寝込む。",
    middleAge: "現実を堅実に生きることに重荷を感じやすい時期。例：住宅ローンと家族のために働く生活に「これでいいのか」と疑問を持つ。夢を思い描くことが増え、家族や社会に縛られることに疑問を抱く。例：家族に内緒で趣味に没頭する時間を作る。自由を手に入れるために思い切った行動に出ることも。例：40代で仕事をセミリタイアして田舎に移住する。これまで現実に根付いて生きてきた人ほどこの傾向が強い。例：20代から30代まで必死に働いた人が40代でスローライフに転向する。",
    lateLife: "頑固さがなく、あっさりとして素直な充実した晩年。例：孫の好きなアイドルを一緒に応援する。可愛げがあるので子どもや孫から好かれ構ってもらえる。例：孫がよく遊びに来て、一緒にゲームをする。悠々自適で怒りも少なく、悟ったような視点で物事を見る。例：「まあなんとかなるさ」と何でも受け入れる。無理に一人で頑張る必要はなく、流れに任せていれば幸せ。例：介護も「お世話になるのが当然」と素直に受け入れる。自由な思考転回が円熟となり、どのような環境でも適応する柔軟さが深まる。"
  },
  "天庫星": {
    childhood: "一つのことにとことんのめり込む集中力のある子ども。例：恐竜に興味を持つと図鑑を何冊も読み、学名をすべて暗記する。真面目で努力家なので、極めたい分野ができたらその道に進むと良い。例：歴史が好きで遺跡を調べ尽くし、将来は考古学者を目指す。先祖との縁は深いが親との縁は薄い。例：お盆やお墓参りを欠かさないが、親とは性格が合わない。祖先を大事にすると助けを得られる。自分で決めた道なら誰が反対しても譲らない頑固さがある。例：親に「もっと稼げる仕事につけ」と言われても自分の道を貫く。",
    middleAge: "奉仕的な生き方が開運につながる時期。家族の縁が深まり、面倒を見ることが多くなる。例：親の介護を引き受け、家族のまとめ役になる。家庭内での役割を全うすると運気が安定する。例：家事も育児も積極的にやり、家族から感謝される。責任を放棄して自己中心的に生きると運気が下がる。例：家庭をないがしろにして趣味に没頭すると、家族との関係が壊れる。仕事も家庭も自分以外のことに注力する時期だが、仕切ることを楽しんで感謝を忘れなければ穏やかに過ごせる。例：PTAや町会の役員を引き受けて、文句を言わずやり遂げる。",
    lateLife: "これまでの知識や努力が役に立つ晩年。例：長年研究した分野で有識者として知られ、テレビや雑誌から取材を受ける。自分の好きなことに熱中していられるので満足感が高い。例：毎日図書館に通って研究を続ける。ただ頑固さが災いすることもある。例：「自分のやり方が正しい」と譲らず、若者と衝突する。一筋の探究心が結実する時期で、自分で決めた道を貫いた成果が現れる。例：30年間続けた研究が認められて賞を受賞する。頑固さが円熟した信念に変わる。"
  },
  "天馳星": {
    childhood: "勉強も友達付き合いも恋愛も忙しく、バラエティに富んだ子ども時代。例：部活も習い事も恋愛も同時にやって毎日忙しい。あちこちに関心があり一か所に留まっていられない。例：趣味が月替わりで、今月は料理、来月は写真と変わる。発想が豊かで面白い子としてムードメーカーになる。例：クラスで「今日は何する？」と提案していつも盛り上げる。親との運勢はかみ合わない。例：親が仕事でうまくいっている時に限って子どもが問題を起こす。病弱になりやすいので無茶は禁物。例：無理をして風邪をこじらせて長引く。成功にも失敗にもこだわらない。例：テストで悪い点を取ってもすぐ忘れて次の日に遊びに行く。",
    middleAge: "波乱や停滞感を感じやすい中年期。働き盛りなのに一番エネルギーの低い運気が巡るため、思い通りにいかないことが多い。例：昇進試験に落ちる、取引先との契約が破談になる。家庭内不和や仕事の不調が続く可能性あり。例：配偶者と意見が合わず別居を考える。流れに抗わず健康を維持することが大切。例：無理をして過労にならず、散歩や軽い運動で体力を保つ。短気を起こさないのが重要。例：思い通りにいかないからといって上司に噛みついて評価をさらに下げるのはNG。運気は必ず上がるので辛抱。例：40代後半から徐々に調子が上がり、50代で飛躍する。",
    lateLife: "せわしく動き回る晩年。体を動かすことが心の平穏につながる。例：毎日朝の散歩を欠かさない、趣味の園芸で毎日庭仕事をする。お金や名誉には無欲なので、社会的な活動より趣味に活動の幅が広がる。例：複数の趣味を同時に楽しみ、毎日忙しい。体の衰えを感じると少し穏やかになる。例：70代まではハイキング、80代からは近所の散歩に変える。単独行動をしがちなので身勝手が過ぎると孤独に。例：自分のペースでばかり動いて家族から「付き合いが悪い」と言われる。家族や友人を大事にすれば穏やかで自由な晩年に。"
  },
};
