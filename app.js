...
const energyLifeInterpretation = {
  ...
  "天堂星": {
    childhood: "自制心・奥手・落ち着きの星。とても落ち着いていて自制心の強い幼年期。不思議なほど真面目で常識人、勤勉。人前に立つことに抵抗感があり、気持ちを表現したり積極的に行動したりすることはあまりできない。若いうちから大人びた慈悲の心を持ち、同年代から頼りにされ年上とは話が弾む。ただ人との交流は多くなく、自分自身の世界を作り着実に能力を磨く。",
    middleAge: "確かな実力を持って補佐役として活躍する中年期。人の前に出ると臆して実力を発揮できないので補佐役が適任。トップに立つと波乱に満ちた人生になるので、堅実に過ごす方を選ぶのが賢明。勤勉なので実力はとてもあり、その力を活かしてひっそりと高みを目指すことも可能。一歩引いた視点から全体を見渡し、後進に道を譲る。自制心が強みだが諦めすぎないよう注意。",
    lateLife: "これまでの人生経験から深みのある言動ができる晩年。とても穏やかで聡明、控えめで若者を立てる。幅広い世代に好かれ穏やかな晩年を過ごす。言葉に深みがあるので人生相談や話の聞き役を口うるさくなく請け負うことができる。たくさん経験を積み交流の幅を広げておくとより安定した楽しい老後に。年齢差のある関係や無言の世界で深いつながりを築く。"
  },
  "天胡星": {
    childhood: "ロマンチスト・音感・直感・感受性の星。大人びた雰囲気がありいろんな感覚が鋭い幼年期。特に音に敏感で音楽が生活の中で重要な位置を占める。空想家でもあり、ひとりでいても自分の作った世界の中で楽しむことができる。宇宙など不思議に溢れた物事に関心を示す。その世界に没頭するので友達付き合いは多いとはいえない。空想と現実の区別がつかなくなることもある。",
    middleAge: "地に足の着いた生活に疑問を抱きやすい中年期。夢見がちなときで、現実的な尺度で生きていると全く違う価値観や考え方が芽生え夢を追いかけ始める。もともと音楽や芸術など夢を売る仕事に就いていれば才能が活かされて満足度の高い中年期に。根を詰める働き方とは相性が良くないので、スケジュールが埋まりすぎない活動の範囲で行うことが長続きのコツ。有から無を感知し無から新たな有を作る時期。集中力が凄まじく精神が肉体を追い込むほど成果が出るが、希望を失うと絶望に沈む。",
    lateLife: "子どものような感性を忘れない晩年。好奇心旺盛で新しいものや若者の流行りに敏感。健康さえ守ることができれば趣味に旅行、仕事など退屈のない生活に。親戚に限らず若い人たちから助けてもらえる運を持つので穏やかで楽しい晩年に。年齢を気にしてできる範囲を決めつける必要はない。精神の世界に深く沈み込み、美へのあこがれを追求する。希望を持ち続けることで精神的な豊かさを得る。"
  },
  "天極星": {
    childhood: "柔軟性・お人好し・解放・無欲の星。素直で従順な可愛がられる幼年期。どこにも留まろうとしないので人の好き嫌いはあまりなく敵を作らない。誘われるがままに遊び多数決に従う。とても穏やかで従順なので特に大人から慕われる。親との運勢がかみ合わない星で、親の運気が良いときは病弱な子になり、親の運気が低迷しているときは健康な子になる。病気やケガが長引きやすいので無茶は禁物。",
    middleAge: "現実を堅実に生きることに重荷を感じやすい中年期。夢を思い描くことが増え、家族や社会に縛られることに疑問を抱く。自由を手に入れるために思い切りのいい行動に出ることも。これまで現実世界に根付いて生きていた人ほどこの傾向が強い。夢想家や孤独を感じやすい環境にいた人にはあまり出ない。環境に順応しながら回帰作用で飛翔する時期。自分の想念に関係なく現実を受け入れ、その中で異次元への飛翔力を発揮する。",
    lateLife: "年齢を重ねたがゆえに出る頑固さがなく、とてもあっさりとしていて素直な晩年。とても充実した晩年に。可愛げがあるので孫や子どもから好かれ構ってもらえる。悠々自適で怒りもさほどわかず、まるで悟ったかのような視点で物事を見る。無理に一人で頑張ろうとしたり意固地になろうとする必要はなく、流れに任せていれば幸せ。自由な思考転回が円熟となり、どのような環境でも適応する柔軟さが深まる。"
  },
  "天庫星": {
    childhood: "凝り性・頑固・歴史の星。一つのことにとことんのめり込んで優れた集中力を発揮する幼年期。真面目で努力家なので極めようと思う分野ができたらその道に進むと良い。先祖との縁は深いが親との縁は薄くなり、親の運気が下がったり親の運気が上がると貧弱な幼年期になったりする。祖先を大事にしていれば助けを得られるので墓入りやお盆などの習慣を大事にする。単一志向に突き進む子で連結のない一筋の探究心を持ち、自分で決めた道なら地獄でも行く自然な頑固さがある。",
    middleAge: "奉仕的な生き方をすることが開運につながる中年期。家族の縁が深まり面倒を見ることが多くなるので家庭内での役割を全うするようにする。責任を放棄して自己中心的に生きると運気が不安定になり不満の多い中年期に。仕事も家庭も自分以外のことに注力しなければいけない時期だが、仕切ることを楽しんで感謝を忘れなければ穏やかに過ごせる。異次元の世界を進む時期で現実を持たず一筋の探究心で突き進む。中庸力とバランス感覚で不自然・不合理を感知する能力が強み。",
    lateLife: "これまでの知識や努力が役に立つ晩年。有識者として知られ世の中の役に立つことが多くなる。自分の好きなことに熱中していられるのでとても満足感の高い晩年に。ただ頑固者であることが災いすることもあるので柔軟性を磨く必要がある。一筋の探究心が結実する時期で現実から精神を学び取る術に優れ、自分で決めた道を貫いた成果が現れる。頑固さが円熟した信念に変わる。"
  },
  "天馳星": {
    childhood: "活動家・ひらめき・救急・無欲の星。勉強も友達付き合いも恋愛も忙しくバラエティに富んだ幼年期。あちらこちらに関心があり一か所にとどまっていられないので時間の限り青春を楽しむ。発想が豊かで面白い子としてムードメーカーになることも。親との運勢はかみ合うことが少なく、親が不調だと好調に親の運気が良いと波乱多き幼年期になる。病弱になる可能性があるので病気やケガに気をつけ無茶は控える。点的今の連続で生きる子で成功も失敗も固執しない。外動内静で動くほど精神は安定する。",
    middleAge: "波乱や停滞感を感じやすい中年期。働き盛りの時期に一番エネルギーの低い運気が巡っているので自分の思い通りに行くことはあまりない。家庭内不和や仕事面での不調が続く可能性がある。流れに抗わず次の良い運気の時期に飛躍できるように健康を維持することが大切。短気を起こさず思い通りにならないというだけで評価が下がるわけではないので自ら自分をおとしめることだけはやめる。運気は必ず上がるので辛抱。分裂・分離の本性で多方面を並行する時期。動くほど精神は安定する。",
    lateLife: "せわしく動き回る晩年。体を動かすことが心の平穏に繋がり満足度の高い時期を過ごせる。お金や名誉には無欲なので社会的な活動より趣味に活動の幅が広がる。体の衰えを感じると少し行動も穏やかになる。単独行動をしがちな星なので身勝手が過ぎると孤独な晩年に。家族や友人を大事にして無理難題を押し付けないように気をつける。霊魂が宇宙空間に帰るような境地に至り、成功も失敗も固執せず静かな精神を保ちながら肉体は動き続ける。穏やかで自由な晩年。"
  }
};
...
function buildReading(name, pillars, mainStars, energy, counts, tenchusatsu, seimei) {
  ...
  const reading = [
    ...
    { title: "金銭感覚とお金の性格", text: `【中心的な性格】${pickByBalance(starP.money, balanceType)}<br><span class="expert-only">【生まれた日の性質】${dayStemMoney[pillars.day.stem] || ""}<br></span>【最も強い要素（${strongest}）】${gogyoMoney[strongest] || ""}${hasSeimei ? `<br>姓名判断の金運スコアは${seimei.moneyFortune}点。${seimei.moneyFortune >= 70 ? "姓名判断的にも金運は良好。" : seimei.moneyFortune >= 50 ? "姓名判断的には標準的。" : "姓名判断的には金運に注意が必要。"}` : ""}` },
    { title: "結婚観と家庭の性格", text: `【中心的な性格】${pickByBalance(starP.marriage, balanceType)}<br><span class="expert-only">【生まれた日の性質】${dayStemMarriage[pillars.day.stem] || ""}<br></span>【最も強い要素（${strongest}）】${gogyoMarriage[strongest] || ""}` },
  ...
  result.innerHTML = `
    ...
    <div class="result-card reading">
      ...
      <div class="simple-only" style="padding:18px;border-left:4px solid var(--accent-color);border-radius:14px;background:rgba(217,164,65,0.08);line-height:1.8;font-size:14px">
        ${pickByBalance(starTexts[mainStars.center], balanceType)}
      </div>
