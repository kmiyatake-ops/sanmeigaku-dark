...
const energyStars = [
  { name: "天報星", score: 3, text: "前例のない新しい道を作るエネルギーを持つが、無自覚・無反省な言動になりやすい。中間点に立つ性質上、行き過ぎると急ブレーキがかかりパニックになりやすい。小刻みの短期決戦を繰り返しながら上昇するのが理想。" },
  { name: "天印星", score: 6, text: "形はあっても中身は空の「有中の無」。目の前の今が指し示す光明に従って歩むエネルギー。人の目に触れないところで事の原因を作り出す無自覚な準備の星。自分を虚にすることで自然に勝利を引き寄せる。" },
  { name: "天貴星", score: 9, text: "人間が初めて「自分」という意識を持つ段階のエネルギー。ピュアでまっすぐな自意識と役割意識の裏側に、弱さと不安を抱える。試練によって磨かれ、積み重ねた知識で教える立場に適する。" },
  { name: "天恍星", score: 7, text: "自分の運命を淘汰し、本質と才能を表に出すエネルギー。現状に居心地の悪さを感じ「ここではないどこか」を求めて脱皮を繰り返す。離郷と冒険の星で、常識に縛られない波動する人生を歩む。" },
  { name: "天南星", score: 10, text: "内的世界への固執が自己主張となり、恐れを知らない前進力で新しい世界を作り出すエネルギー。自分を曲げられない純粋さと不器用さが怒りとなり、環境を変える荒っぽい改革者の役割を持つ。" },
  { name: "天禄星", score: 11, text: "自己保身的中庸バランスを持ち、精神より生存を先に考えるエネルギー。健康と経済の安定が人生の基盤で、地味な積み重ねの努力で職人として真価を発揮する。経験則に基づく未来予測力を持つ。" },
  { name: "天将星", score: 12, text: "気が「極象」であり極まることで転換する役割。創造と破壊を繰り返しながら次元を上げる波動の人生。最大エネルギーゆえに精神世界に安住できず、常に精神性を渇望しながら現実を生きる。自我と頑固さはどの星より強く、自分を無にできない。" },
...
const energyLifeInterpretation = {
  "天報星": {
    childhood: "前例のない道を切り開く子ども。周囲と違う方向に興味を持ちやすく、親の期待通りには進みにくい。型にはめず、個性を伸ばす接し方が必要。",
    middleAge: "新しい分野に挑戦し続ける時期。短期決戦を繰り返しながら上昇するが、行き過ぎると急ブレーキがかかる。小刻みに成果を出す戦略が鍵。",
    lateLife: "これまでの型破りな経験が智恵になる。後進に道を示す役割だが、無自覚な言動には注意。落ち着きを持つことで円熟味が増す。"
  },
  "天印星": {
    childhood: "目に見えない準備をする子ども。表向きは目立たなくても、内面で確かな基礎を築いている。焦らず見守ることが大切。",
    middleAge: "縁の下の力持ちとして実績を積む時期。目立たないところで事の原因を作り、自然に勝利を引き寄せる。虚にして実を取る戦略が成功の鍵。",
    lateLife: "これまでの準備が形になる時期。人の目に触れないところで培ったものが、後進の道標になる。静かな充実感を得やすい晩年。"
  },
  "天貴星": {
    childhood: "ピュアでまっすぐな自意識を持つ子ども。純粋さゆえに傷つきやすい面も。試練を通じて磨かれることで、教える立場への素地ができる。",
    middleAge: "積み重ねた知識と経験で教える立場に適する時期。純粋さを活かしつつ、現実的な判断力も身につく。試練を乗り越えるたびに評価が高まる。",
    lateLife: "後進を導く円熟した時期。これまでの試練が智恵となり、多くの人に慕われる存在に。純粋さを保ちながら穏やかな晩年を送りやすい。"
  },
  "天恍星": {
    childhood: "現状に居心地の悪さを感じる子ども。引っ越しや転校など環境の変化が多い。常識に縛られない自由な発想が才能。",
    middleAge: "脱皮を繰り返しながら本質を表に出す時期。離郷や冒険、キャリアチェンジが起きやすい。居心地の悪さを信号にして次のステージへ進む。",
    lateLife: "波乱に富んだ人生を総括する時期。これまでの冒険が豊かな経験談になる。常識に縛られない生き方を後進に伝える役割。"
  },
  "天南星": {
    childhood: "恐れを知らない前進力を持つ子ども。自分を曲げられない純粋さと不器用さが、環境を変える力になる。怒りをうまく活かす指導が必要。",
    middleAge: "改革者として環境を変える時期。自分の世界を主張し、新しい秩序を作る。不器用さゆえに摩擦も多いが、その純粋さが人を動かす。",
    lateLife: "これまでの改革が実を結ぶ時期。頑固さは円熟味に変わり、若い世代の道を開く存在に。怒りを静めることで深い智恵が現れる。"
  },
  "天禄星": {
    childhood: "生存を先に考える堅実な子ども。健康と経済の基盤を大切にする。地味な積み重ねを嫌がらず、職人としての素質が早くから現れる。",
    middleAge: "地味な積み重ねで職人として真価を発揮する時期。経験則に基づく未来予測力が強み。堅実さが大きな安定をもたらす。",
    lateLife: "堅実に築いた基盤が支える安定した晩年。健康と経済の安定を保ちながら、経験則を次世代に伝える。地味だが充実した時期。"
  },
  "天将星": {
    childhood: "最大エネルギーゆえに精神世界に安住できない子ども。常に精神性を渇望しながら現実を生きる。自我と頑固さがどの星より強い。",
    middleAge: "創造と破壊を繰り返しながら次元を上げる時期。極まったエネルギーが転換点を作り、波乱の中で大きな成果を生む。自分を無にできない強さが武器。",
    lateLife: "波乱の人生を総括し、次の次元へ移行する時期。自我を手放すことで真の円熟に至る。精神性の深化が晩年のテーマ。"
  },
  "天堂星": {
